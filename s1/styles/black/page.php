...
<link href="styles/<?php echo STYLE;?>/scripts/cmts.css" rel="stylesheet" type="text/css" />
...
<div id="page">
<div id="date"><?php get_date();?></div>
<?php get_contents();?>
</div><!--page-->

<?php require "includes/get_cmts.php";?>

<div id="footer_links">
<?php require "includes/get_link.php"; ?>
</div><!--footer_links-->
